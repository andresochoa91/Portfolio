...
const Contact: React.FC = () => {
  return (
    <article className="mw6 center bg-white br3 pa3 pa4-ns mv3 ba b--black-10">
      ...
      <footer className="pt3 pb1 ph3 tc">
        <a className="link hover-silver near-black dib mh3 tc" href="https://www.linkedin.com/in/jandresochoa91/" title="LinkedIn" target="_blank" rel="noopener noreferrer">
        ...
        <a className="link near-black hover-silver dib mh3 tc" href="https://github.com/andresochoa91" title="GitHub" target="_blank" rel="noopener noreferrer">
